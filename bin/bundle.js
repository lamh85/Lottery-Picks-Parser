...
/***/ function(module, exports, __webpack_require__) {
	...
	var submitToProcessor = function submitToProcessor(rawInput) {
	  ...
	  return (0, _baseProcessor2.default)(filteredArray);
	};
	...
	(0, _jquery2.default)(document).ready(function () {
	  ...
	  (0, _jquery2.default)("button").click(handleSubmit);
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var validateEachPick = function validateEachPick(picks) {
	  ...
	  return (0, _makeResponse2.default)("success", "Yes, you can make valid lotto picks.");
	};
	...
	var markersMakerBase = function markersMakerBase(picksString, numberOfSingleDigits) {
	...
	var allAreSingleDigits = function allAreSingleDigits(picksString) {
	  var picks = picksString.match(/.{1}/g);
	  var validationResult = validateEachPick(picks);
	  if (validationResult.status == "success") {
	    return (0, _makeResponse2.default)("success", picks);
	  } else {
	    return (0, _makeResponse2.default)("failed", "Cannot make valid lotto picks with this string.");
	  }
	};

	var allAreDoubleDigits = function allAreDoubleDigits(picksString) {
	...
	var stringHasValidPicks = function stringHasValidPicks(picksString, markerListsArray) {
	  var parsedString = [];
	  ...
	  for (var listsIndex = 0; listsIndex < markerListsArray.length; listsIndex++) {
	    ...
	    if (parsedString.length == 7) {
	      return (0, _makeResponse2.default)("success", parsedString);
	    }
	  } // End testing all parsing patterns

	  return (0, _makeResponse2.default)("failed", "Cannot find a parsing pattern that produces valid lotto picks");
	};
